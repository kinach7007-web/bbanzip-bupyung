...
export const PL_DATA = {
  ...
  expenses: [
    ...
    { 
      ...
      ratio: 0,
      details: [
        { name: "네이버광고", amount: 0, ratio: 0 },
        { name: "블로그", amount: 0, ratio: 0 },
        { name: "당근광고", amount: 0, ratio: 0 },
        { name: "인스타광고", amount: 0, ratio: 0 },
        { name: "틱톡광고", amount: 0, ratio: 0 },
        { name: "인스타 인플루언서", amount: 0, ratio: 0 },
        { name: "기타 마케팅", amount: 0, ratio: 0 }
      ]
    },
    { 
      name: "카드수수료(1.9%)", 
  ...
  vendors: {
    '매출': [],
    '2-1. 원자재(육류)': ['뼈(제일축산)', '모자반(제주)'],
    '2-2. 식자재&공산품': ['우리과일야채(조병윤)'],
    '주류&음료': ['주류'],
    '인건비': [],
    '변동비': ['가스비'],
    '마케팅': ['네이버광고'],
